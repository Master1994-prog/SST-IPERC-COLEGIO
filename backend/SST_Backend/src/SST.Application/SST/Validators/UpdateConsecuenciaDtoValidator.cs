...
/// <summary>
/// Validador para actualizar una consecuencia.
/// </summary>
public class UpdateConsecuenciaDtoValidator : AbstractValidator<UpdateConsecuenciaDto>
{
    public UpdateConsecuenciaDtoValidator()
    {
