...
/// <summary>
/// Validador para registrar un tipo de Equipo de Protección Personal.
/// </summary>
public class CreateTipoEquipoProteccionDtoValidator : AbstractValidator<CreateTipoEquipoProteccionDto>
{
    public CreateTipoEquipoProteccionDtoValidator()
    {
        RuleFor(x => x.Codigo)
            .NotEmpty()
