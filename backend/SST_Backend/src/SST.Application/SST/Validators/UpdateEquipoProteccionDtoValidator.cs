...
/// <summary>
/// Validador para actualizar un Equipo de Protección Personal.
/// </summary>
public class UpdateEquipoProteccionDtoValidator : AbstractValidator<UpdateEquipoProteccionDto>
{
    public UpdateEquipoProteccionDtoValidator()
    {
        RuleFor(x => x.Codigo)
            .NotEmpty()
