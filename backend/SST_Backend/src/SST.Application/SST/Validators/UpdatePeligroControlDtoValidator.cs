...
/// <summary>
/// Validador para actualizar una relación peligro-control.
/// </summary>
public class UpdatePeligroControlDtoValidator : AbstractValidator<UpdatePeligroControlDto>
{
    public UpdatePeligroControlDtoValidator()
    {
