...
/// <summary>
/// Validador para registrar una relación peligro-consecuencia.
/// </summary>
public class CreatePeligroConsecuenciaDtoValidator : AbstractValidator<CreatePeligroConsecuenciaDto>
{
    public CreatePeligroConsecuenciaDtoValidator()
    {
