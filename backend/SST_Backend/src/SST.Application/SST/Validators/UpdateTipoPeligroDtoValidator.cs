...
/// <summary>
/// Validador para actualizar un tipo de peligro.
/// No valida Id porque el Id llega desde la ruta del controlador.
/// </summary>
public class UpdateTipoPeligroDtoValidator : AbstractValidator<UpdateTipoPeligroDto>
{
    public UpdateTipoPeligroDtoValidator()
    {
