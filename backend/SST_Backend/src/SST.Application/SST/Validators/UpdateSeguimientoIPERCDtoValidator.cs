...
/// <summary>
/// Validador para actualizar un seguimiento IPERC.
/// </summary>
public class UpdateSeguimientoIPERCDtoValidator : AbstractValidator<UpdateSeguimientoIPERCDto>
{
    public UpdateSeguimientoIPERCDtoValidator()
    {
