...
/// <summary>
/// Validador para registrar una evaluación de riesgo.
/// </summary>
public class CreateEvaluacionRiesgoDtoValidator : AbstractValidator<CreateEvaluacionRiesgoDto>
{
    public CreateEvaluacionRiesgoDtoValidator()
    {
