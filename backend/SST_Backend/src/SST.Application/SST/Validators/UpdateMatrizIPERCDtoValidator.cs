...
/// <summary>
/// Validador para actualizar una Matriz IPERC.
/// No valida Codigo porque el código es automático y no se edita.
/// </summary>
public class UpdateMatrizIPERCDtoValidator : AbstractValidator<UpdateMatrizIPERCDto>
{
    public UpdateMatrizIPERCDtoValidator()
    {
        RuleFor(x => x.Nombre)
            .NotEmpty()
